...
import com.devcoop.kiosk.domain.paylog.repository.UserRepository;
import com.devcoop.kiosk.domain.paylog.repository.KioskReceiptRepository;
import com.devcoop.kiosk.domain.paylog.repository.ItemRepository;
import com.devcoop.kiosk.domain.paylog.entity.User;
import com.devcoop.kiosk.domain.paylog.entity.PayLog;
import com.devcoop.kiosk.domain.paylog.entity.KioskReceipt;
import com.devcoop.kiosk.domain.paylog.entity.Item;
import com.devcoop.kiosk.domain.paylog.dto.UserPointRequest;
import com.devcoop.kiosk.domain.paylog.dto.PayLogRequest;
import com.devcoop.kiosk.domain.paylog.dto.KioskRequest;
import com.devcoop.kiosk.domain.paylog.dto.KioskItemInfo;
import com.devcoop.kiosk.domain.paylog.dto.Payments;
import com.devcoop.kiosk.domain.paylog.enums.ReceiptType;
...
public class SelfCounterService {
    ...
    @Autowired
    public SelfCounterService(PayLogRepository payLogRepository, UserRepository userRepository,
                              KioskReceiptRepository kioskReceiptRepository, ItemRepository itemRepository) {
    ...
    private int deductPoints(UserPointRequest userPointRequest) {
    ...
    private void savePayLog(PayLogRequest payLogRequest) {
        try {
    ...
    private void saveReceipt(KioskRequest kioskRequest) {
        try {
